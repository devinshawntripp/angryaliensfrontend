...
contract AlienToken is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Alien Token", "AT") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 20456742e18, "CONSTR: totalSupply must equal 20 million");
